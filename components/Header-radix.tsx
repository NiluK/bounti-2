...
import { faCode, faCog, faPlay, faSignOut, faUserCircle } from '@fortawesome/free-solid-svg-icons';
...
export const Header = () => {
  ...
  const { profile, setProfileType, profileType } = useContext(ProfileContext);
  const user = useUser()?.user?.user_metadata;
                      ...
                      >
                        <Flex gap="3">
                          ...
                          <Box>
                            ...
                            <Text size="2" as="p" variant="gray" css={{ lineHeight: 1.4 }}>
                              Switches your profile to game dev mode
                            </Text>
                          </Box>
                        </Flex>
                      </HighlightLink>
                      ...
                      >
                        <Flex gap="3">
                          ...
                          <Box>
                            ...
                            <Text size="2" as="p" variant="gray" css={{ lineHeight: 1.4 }}>
                              Switches your profile to playtest mode
                            </Text>
                          </Box>
                        </Flex>
                      </HighlightLink>
                    )}
                    <HighlightLink href="/api/auth/logout">
                      <Flex gap="3">
                        <FontAwesomeIcon
